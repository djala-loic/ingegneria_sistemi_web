...
<%@ page import="com.esame.kit.model.mo.*" %>
...
<%  boolean loggedOn = (Boolean) request.getAttribute("loggedOn");
    ...
    String menuActiveLink = "Prenotazioni";
...
<div class="container">
    <%@include file="/includes/prenotazioni/layout/hero.inc"%>
    <%@include file="/includes/prenotazioni/edit/editPrenotazione.inc"%>
</div>

<%@include file="/includes/templates/layout/editorCDN.inc"%>
<%@include file="/includes/prenotazioni/edit/script.inc"%>
<%@include file="/includes/prenotazioni/layout/viewScriptJs.inc"%>
