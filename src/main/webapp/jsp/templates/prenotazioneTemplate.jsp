...
<%  boolean loggedOn = (Boolean) request.getAttribute("loggedOn");
    ...
    User mittente = (User) request.getAttribute("mittente");
    User destinatario = (User) request.getAttribute("destinatario");
...
<div class="container">
    ...
    <%@include file="/includes/templates/prenotation/formPrenotation.inc"%>
</div>

<%@include file="/includes/templates/layout/editorCDN.inc"%>
<%@include file="/includes/templates/prenotation/script.inc"%>
<%@include file="/includes/templates/layout/viewScriptJs.inc"%>
<%@include file="/includes/templates/layout/codeView.inc"%>
